defmodule MiewWeb.MatchLive do
  ...
  def mount(params, _session, socket) do
    ...
    results =
      ...
      |> Miew.list_games()
      |> Enum.map(fn g ->
        %{id: g.id, turns: g.turns, results: Miew.list_results(g.results), time: g.time}
      end)
  ...
  defp to_atom_game_data(match) do
    %{
      match: match.id,
      deck_1: match.deck_one,
      deck_2: match.deck_two,
      player_1: match.player_one,
      player_2: match.player_two,
      winner: 0,
      balance: nil,
      power_1: nil,
      power_2: nil,
